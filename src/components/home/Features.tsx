...
const features: Feature[] = [
  ...
  },
  {
    ...
    icon: IconGraph,
    color: "green.400",
    description: "Analyze your click counts, page views and take data driven decisions.",
  },
  {
    title: "Testimonials",
    icon: IconMessages,
    color: "blue.400",
    description: "Collect testimonials from the visitors and showcase them in your profile.",
  },
  {
    title: "Form Submissions",
    icon: IconFiles,
    color: "orange.400",
    description: "Collect form submissions from the visitors and manage them from your dashboard.",
  },
  {
    title: "Newsletter",
    icon: IconMail,
