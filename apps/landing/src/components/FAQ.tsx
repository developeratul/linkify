...
const questions: Question[] = [
  ...
  },
  {
    ...
    answer:
      "It will be mostly free but some of the parts will require a subscription.",
  },
  {
    question: "How can I show my appreciation?",
    answer:
      "Consider joining the wait list and fund the project with a small donation :)",
  },
];
  ...
  return (
    <SectionWrapper id="faq">
      <Chakra.VStack w="full" spacing={10}>
        ...
        <Chakra.Accordion rounded="md" bg="white" allowToggle w="full">
